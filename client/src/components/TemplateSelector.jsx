...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
    ...
    const templates = [
        {
            id: 'classic',
            name: 'Classic',
            preview: "A clean trditional resume format with clear sections and professional typography"
        },
        {
            id: 'modern',
            name: 'Modern',
        ...
        },
        {
            ...
            preview: "elegant design that puts your content center and stylish"
        },
    ]
    ...
    return (
        <div className='relative'>
            ...
            {
                isOpen && (
                    <div className='absolute top-full w-xs p-3 mt-3 space-y-3 z-10 bg-white rounded-md border border-gray-200 shadow-sm'>
                        {templates.map((template) => (
                            <div onClick={() => { onChange(template.id); setIsOpen(false) }} key={template.id}
